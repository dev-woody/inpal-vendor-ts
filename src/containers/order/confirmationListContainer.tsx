import ConfirmationList from "components/order/confirmation/confirmationList";
...
const ConfirmationListContainer = () => {
  ...
  return (
    <ConfirmationList confirmationList={orderList} countOrder={countOrder} />
  );
};
