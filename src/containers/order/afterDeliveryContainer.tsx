import AfterDelivery from "components/order/afterDelivery/afterDelivery";
...
const AfterDeliveryContainer = () => {
  ...
  //* afterDelivery
  const afterDeliveryColumns: ColumnsType[] = [
    {
      title: "번호",
      dataIndex: "",
  ...
  return (
    <AfterDelivery
      afterDelivery={orderList}
      afterDeliveryColumns={afterDeliveryColumns}
    />
  );
};

export default AfterDeliveryContainer;
