...
const RefundDetailBlock = styled(Responsive)``;

type refundDetailProps = {
  refundDetail?: { [key: string]: any };
};

// const RefundDetail = ({ data }: refundDetailProps) => {
const RefundDetail = ({ refundDetail }: refundDetailProps) => {
