...
const CancelDetailBlock = styled(Responsive)``;

type cancelDetailProps = {
  cancelDetail?: { [key: string]: any };
};

// const CancelDetail = ({ data }: cancelDetailProps) => {
const CancelDetail = ({ cancelDetail }: cancelDetailProps) => {
