...
const ExchangeDetailBlock = styled(Responsive)``;

type exchangeDetailProps = {
  exchangeDetail?: { [key: string]: any };
};

// const ExchangeDetail = ({ data }: exchangeDetailProps) => {
const ExchangeDetail = ({ exchangeDetail }: exchangeDetailProps) => {
